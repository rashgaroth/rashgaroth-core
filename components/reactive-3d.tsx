...
export default function ReactiveEffect() {
  return (
        ...
        <Html>
          <div className="grid grid-cols-2 gap-0">
            <div className="flex flex-col items-center justify-center w-full">
              <h1 className={title({ size: "lg", class: "font-vt323" })}>Dynamic&nbsp;</h1>
              <h1 className={title({ size: "lg", class: "font-vt323"  })}>Never&nbsp;</h1>
              <h1 className={title({ color: "violet", size: "lg", class: "font-vt323" })}>Ends&nbsp;</h1>
            </div>
          </div>
        </Html>
        {/* @ts-ignore */}
